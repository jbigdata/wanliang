    ...
    <div class="row">
        ...
        <div class="col-sm-3">
            <div class="row box_white sidebar">
                <div class="top">
                    <h3 class="title"><i class="glyphicon glyphicon-fire"></i>&nbsp;栏目列表</h3>
                </div>
            ...
            <div class="row box_white sidebar">
                <div class="top">
                    <h3 class="title"><i class="glyphicon glyphicon-fire"></i>&nbsp;推荐阅读</h3>
                </div>
                <div class="sb-content">
                    <div class="project-list" data-limit="5">
                        <ul class="list-unstyled">
            ...
            <c:forEach items="${categoryList}" var="tpl">
                <c:if test="${tpl.inList eq '1' && tpl.module ne ''}">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">${tpl.name}
                                ...
                                <article class="article box_white">
                                    <div class="row">
                                        ...
                                        <div>
                                            ...
                                            <p class="text">${article.description}<a href="${article.url}"
                                                                                     target="_blank"
                                                                                     title="阅读全文">阅读全文</a></p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8 metatag">
                                            ...
                                            <span class="date" title="发布日期"><fmt:formatDate
                                                    value="${article.updateDate}" pattern="yyyy-MM-dd"/></span>
						...
						<span class="view" title="阅读数">
							...
							阅读:<span>${article.hits}</span>次
                                            ...
                                            <a href="/articles/4812#commentForm" class="cmt" target="_blank"
                                               title="评论数">
                                                <i class="glyphicon glyphicon-comment"></i>
                                                评论:<span>1</span>条
                                            </a>

                                            <a href="#" class="like" title="我喜欢" data-objid="4812" data-objtype="1"
                                               data-flag="0">
                        ...
                        <c:if test="${tpl.module eq 'link'}">
                            <ul class="list-group"><c:forEach items="${fnc:getLinkList(site.id, tpl.id, 5, '')}"
                                                              var="link">
                                <li class="list-group-item"><span class="pull-right"><fmt:formatDate
                                        value="${link.updateDate}"
