...
<div class="main-container">
    ...
    <header class="block">
        <ul class="header-menu horizontal-list">
            <li>
                <a class="header-menu-tab" href="#1"><span class="icon entypo-cog scnd-font-color"></span>设置</a>
            </li>
            <li>
                <a class="header-menu-tab" href="#2"><span class="icon fontawesome-user scnd-font-color"></span>账号</a>
            </li>
            <li>
                <a class="header-menu-tab" href="#3"><span class="icon fontawesome-envelope scnd-font-color"></span>信息</a>
                <a class="header-menu-number" href="#4">2</a>
            </li>
            <li>
                <a class="header-menu-tab" href="#5"><span class="icon fontawesome-star-empty scnd-font-color"></span>收藏</a>
            </li>
        </ul>
        <div class="profile-menu">
            <p>本人 <a href="#26"><span class="entypo-down-open scnd-font-color"></span></a></p>
            <div class="profile-picture small-profile-picture">
                <img width="40px" alt="Anne Hathaway picture" src="http://www.gbtags.com/gb/laitu/40x40/cc324b">
            </div>
        </div>
    </header>
    ...
    <div class="left-container container">
        <div class="menu-box block">
            <h2 class="titular">菜单</h2>
            <ul class="menu-box-menu">
                <li>
                    <a class="menu-box-tab" href="#6"><span class="icon fontawesome-envelope scnd-font-color"></span>消息<div class="menu-box-number">24</div></a>
                </li>
                <li>
                    <a class="menu-box-tab" href="#8"><span class="icon entypo-paper-plane scnd-font-color"></span>邀请<div class="menu-box-number">3</div></a>
                </li>
                <li>
                    <a class="menu-box-tab" href="#10"><span class="icon entypo-calendar scnd-font-color"></span>事件<div class="menu-box-number">5</div></a>
                </li>
                <li>
                    <a class="menu-box-tab" href="#12"><span class="icon entypo-cog scnd-font-color"></span>账号设定</a>
                </li>
                <li>
                    <a class="menu-box-tab" href="#13"><sapn class="icon entypo-chart-line scnd-font-color"></sapn>统计</a>
                </li>
            </ul>
        </div>
        <div class="donut-chart-block block">
            <h2 class="titular">状态</h2>
            <div class="donut-chart">
                ...
                <p class="center-date">九月<br><span class="scnd-font-color">2015</span></p>
            </div>
        ...
        <div class="line-chart-block block clear"> <!-- LINE CHART BLOCK (LEFT-CONTAINER) -->
          ...
          <span data-valor='25'>
            ...
            <ul class="time-lenght horizontal-list">
                <li><a class="time-lenght-btn" href="#14">周</a></li>
                <li><a class="time-lenght-btn" href="#15">月</a></li>
                <li><a class="time-lenght-btn" href="#16">年</a></li>
            </ul>
    ...
    <div class="middle-container container">
        <div class="profile block"> <!-- PROFILE (MIDDLE-CONTAINER) -->
            ...
            <div class="profile-picture big-profile-picture clear">
                <img width="150px" alt="Anne Hathaway picture" src="http://www.gbtags.com/gb/laitu/150x150&text=Jack/#cc324b/ffffff" >
            </div>
            <h1 class="user-name">Jack Lee</h1>
            <div class="profile-description">
                <p class="scnd-font-color">Geek的世界</p>
            </div>
        ...
        <div class="weather block clear"> <!-- WEATHER (MIDDLE-CONTAINER) -->
            <h2 class="titular"><span class="icon entypo-location"></span><strong>北京</strong></h2>
            <div class="current-day">
                <p class="current-day-date">2015/09/06</p>
                <p class="current-day-temperature">24o<span class="icon-cloudy"></span></p>
            </div>
            <ul class="next-days">
                <li>
                    <a href="#43">
                        <p class="next-days-date"><span class="day">SAT</span> <span class="scnd-font-color">29/06</span></p>
                        <p class="next-days-temperature">25o<span class="icon icon-cloudy scnd-font-color"></span></p>
                    </a>
                </li>
                <li>
                    <a href="#44">
                        <p class="next-days-date"><span class="day">SUN</span> <span class="scnd-font-color">30/06</span></p>
                        <p class="next-days-temperature">22o<span class="icon icon-cloudy2 scnd-font-color"></span></p>
                    </a>
                </li>
                <li>
                    <a href="#45">
                        <p class="next-days-date"><span class="day">MON</span> <span class="scnd-font-color">01/07</span></p>
                        <p class="next-days-temperature">24o<span class="icon icon-cloudy2 scnd-font-color"></span></p>
                    </a>
                </li>
                <li>
                    <a href="#46">
                        <p class="next-days-date"><span class="day">TUE</span> <span class="scnd-font-color">02/07</span></p>
                        <p class="next-days-temperature">26o<span class="icon icon-cloudy scnd-font-color"></span></p>
                    </a>
                </li>
                <li>
                    <a href="">
                        <p class="next-days-date"><span class="day">WED</span> <span class="scnd-font-color">03/07</span></p>
                        <p class="next-days-temperature">27o<span class="icon icon-sun scnd-font-color"></span></p>
                    </a>
                </li>
                <li>
                    <a href="">
                        <p class="next-days-date"><span class="day">THU</span> <span class="scnd-font-color">04/07</span></p>
                        <p class="next-days-temperature">29o<span class="icon icon-sun scnd-font-color"></span></p>
                    </a>
                </li>
            </ul>
        </div>
        <div class="tweets block">
            <h2 class="titular"><span class="icon zocial-twitter"></span>微博消息</h2>
            <div class="tweet first">
                <p>昨天又雾霾啦~~ <a class="tweet-link" href="#17">@gbtags.com</a></p>
                <p><a class="time-ago scnd-font-color" href="#18">3分钟前</a></p>
            </div>
            <div class="tweet">
                <p>今天阅兵结束啦</p>
                <p><a class="scnd-font-color" href="#20">6天前</a></p>
            </div>
        </div>
        <ul class="social block">
            <li><a href="#50"><div class="facebook icon"><span class="zocial-facebook"></span></div><h2 class="facebook titular">分享到FB</h2></li></a>
            <li><a href="#51"><div class="twitter icon"><span class="zocial-twitter"></span></div><h2 class="twitter titular">分享到微博</h2></li></a>
            <li><a href="#52"><div class="googleplus icon"><span class="zocial-googleplus"></span></div><h2 class="googleplus titular">分享到极客标签</h2></li></a>
        </ul>
    </div>
    ...
    <div class="right-container container">
        <div class="join-newsletter block"> <!-- JOIN NEWSLETTER (RIGHT-CONTAINER) -->
            <h2 class="titular">订阅邮件</h2>
            <div class="input-container">
                <input type="text" placeholder="yourname@gbtags.com" class="email text-input">
                <div class="input-icon envelope-icon-newsletter"><span class="fontawesome-envelope scnd-font-color"></span></div>
            </div>
            <a class="subscribe button" href="#21">立刻订阅</a>
        </div>
        <div class="account block"> <!-- ACCOUNT (RIGHT-CONTAINER) -->
            <h2 class="titular">这里登录</h2>
            <div class="input-container">
            ...
            <a class="sign-in button" href="#22">登录</a>
            <p class="scnd-font-color">找回密码？</p>
            <a class="fb-sign-in" href="58">
                <p><span class="fb-border"><span class="icon zocial-facebook"></span></span>使用微博登陆</p>
            </a>
        </div>
        <div class="loading block"> <!-- LOADING (RIGHT-CONTAINER) -->
            <div class="progress-bar downloading"></div>
            <p><span class="icon fontawesome-cloud-download scnd-font-color"></span>下载中...</p>
            <p class="percentage">81<sup>%</sup></p>
            <div class="progress-bar uploading"></div>
            <p><span class="icon fontawesome-cloud-upload scnd-font-color"></span>上传中...</p>
        ...
        <div class="calendar-month block"> <!-- CALENDAR MONTH (RIGHT-CONTAINER) -->
            <div class="arrow-btn-container">
                ...
                <h2 class="titular">2015/09/07</h2>
